...
class VectorStore:
    ...
    def get_course_outline(self, course_name: str) -> Optional[Dict[str, Any]]:
        """
        Get the full outline (title, course link, and lesson list) for a course,
        resolving the course name fuzzily against the course_catalog collection.

        Returns a dict with 'title', 'course_link', 'instructor', and 'lessons'
        (each lesson: 'lesson_number', 'lesson_title', 'lesson_link'), or None
