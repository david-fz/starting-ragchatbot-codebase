...
def test_execute_with_results_and_no_filters_formats_and_queries_correctly(mock_vector_store):
...
def test_execute_empty_results_no_filters(mock_vector_store, search_results_factory):
    mock_vector_store.search.return_value = search_results_factory(documents=[], metadatas=[])
    tool = CourseSearchTool(mock_vector_store)
...
def test_execute_empty_results_with_course_name_only(mock_vector_store, search_results_factory):
    mock_vector_store.search.return_value = search_results_factory(documents=[], metadatas=[])
    tool = CourseSearchTool(mock_vector_store)
...
def test_execute_empty_results_with_lesson_number_only(mock_vector_store, search_results_factory):
    mock_vector_store.search.return_value = search_results_factory(documents=[], metadatas=[])
    tool = CourseSearchTool(mock_vector_store)
...
def test_execute_empty_results_with_course_name_and_lesson_number(mock_vector_store, search_results_factory):
    mock_vector_store.search.return_value = search_results_factory(documents=[], metadatas=[])
    tool = CourseSearchTool(mock_vector_store)
...
def test_execute_dedupes_sources_from_same_lesson_and_resolves_lesson_link(mock_vector_store, search_results_factory):
...
def test_execute_course_level_chunk_resolves_course_link_not_lesson_link(mock_vector_store, search_results_factory):
    mock_vector_store.search.return_value = search_results_factory(
